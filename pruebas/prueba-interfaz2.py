...
class SpotifyStylePlayer:
    def __init__(self, root):
        ...
        self.playlist = Playlist("Mis favoritos")
        self.setup_styles()
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        header.create_text(20, 75, text="Mis favoritos", anchor='w',
        ...
        # Usar texto en lugar de imágenes para los botones
        ...
        self.remove_btn = tk.Button(btn_frame, text="Eliminar", font=('Arial', 10),
    ...
    def on_select(self, event):
        pass  # Selección visual manejada automáticamente
    ...
    def eliminar_cancion(self):
        ...
        if messagebox.askyesno("Confirmar eliminación", 
            ...
            if cancion_eliminada:
                # Si eliminamos la canción actual, actualizar reproductor
